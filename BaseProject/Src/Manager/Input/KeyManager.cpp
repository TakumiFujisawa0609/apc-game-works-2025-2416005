...
#define SET_C_OTHERS(type,key)controllerOthersFormat[(int)type].emplace_back(key)
	...
	SET_KEYBOARD(KEY_TYPE::DASH, KEY_INPUT_SPACE);
	SET_KEYBOARD(KEY_TYPE::DASH, KEY_INPUT_B);
	SET_C_BUTTON(KEY_TYPE::DASH, XINPUT_BUTTON_A);
	...
	SET_KEYBOARD(KEY_TYPE::SHOT, KEY_INPUT_H);
	SET_C_BUTTON(KEY_TYPE::SHOT, XINPUT_BUTTON_Y);
	SET_MOUCE_BUTTON(KEY_TYPE::SHOT, MOUSE_INPUT_RIGHT);

	SET_KEYBOARD(KEY_TYPE::SP, KEY_INPUT_Q);
	SET_C_BUTTON(KEY_TYPE::SP, XINPUT_BUTTON_B);

	SET_KEYBOARD(KEY_TYPE::UP, KEY_INPUT_LSHIFT);
	SET_C_BUTTON(KEY_TYPE::UP, XINPUT_BUTTON_LEFT_SHOULDER);

	SET_KEYBOARD(KEY_TYPE::GARD, KEY_INPUT_G);
	SET_C_BUTTON(KEY_TYPE::GARD, XINPUT_BUTTON_RIGHT_SHOULDER);
	...
	SET_KEYBOARD(KEY_TYPE::GAME_NEXT, KEY_INPUT_ESCAPE);
	SET_C_BUTTON(KEY_TYPE::GAME_NEXT, XINPUT_BUTTON_A);

	SET_KEYBOARD(KEY_TYPE::HASEI, KEY_INPUT_H);
	SET_C_BUTTON(KEY_TYPE::HASEI, XINPUT_BUTTON_Y);
	SET_MOUCE_BUTTON(KEY_TYPE::HASEI, MOUSE_INPUT_RIGHT);

	SET_KEYBOARD(KEY_TYPE::KARI, KEY_INPUT_F);
...
void KeyManager::MouceUpdate(void)
{
	...
	mouceInfo.move = AsoUtility::Normalize(mouceInfo.now - mouceInfo.prev);
